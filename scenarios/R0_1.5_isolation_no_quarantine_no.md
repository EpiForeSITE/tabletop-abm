...
![](R0_1.5_isolation_no_quarantine_no_files/figure-commonmark/unnamed-chunk-2-1.png)
...
![](R0_1.5_isolation_no_quarantine_no_files/figure-commonmark/unnamed-chunk-3-1.png)
...
```
    ...
    Total elapsed t     : 46.00s (200 runs)
    Last run speed      : 2.75 million agents x day / second
    Average run speed   : 162.91 million agents x day / second
    Rewiring            : off
...
![](R0_1.5_isolation_no_quarantine_no_files/figure-commonmark/timeline-outbreak-size-1.png)
...
![](R0_1.5_isolation_no_quarantine_no_files/figure-commonmark/hist-outbreak-size-1.png)
