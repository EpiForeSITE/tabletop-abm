...
Looking at the single simulation results
    ...
    Last run speed      : 4.54 million agents x day / second
    Rewiring            : off
...
Reproductive number distribution for the index case (Average R0: 1.45 )
...
the `hist` function:
    ...
    Warning in xy.coords(x, y, xlabel, ylabel, log): 1053 y values <= 0 omitted
