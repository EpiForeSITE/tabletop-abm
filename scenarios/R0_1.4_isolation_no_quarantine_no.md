...
![](R0_1.4_isolation_no_quarantine_no_files/figure-commonmark/unnamed-chunk-2-1.png)
...
![](R0_1.4_isolation_no_quarantine_no_files/figure-commonmark/unnamed-chunk-3-1.png)
...
```
    ...
    Last run speed      : 3.45 million agents x day / second
    Average run speed   : 178.49 million agents x day / second
    Rewiring            : off
...
![](R0_1.4_isolation_no_quarantine_no_files/figure-commonmark/timeline-outbreak-size-1.png)
...
![](R0_1.4_isolation_no_quarantine_no_files/figure-commonmark/hist-outbreak-size-1.png)
